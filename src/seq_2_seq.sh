...
#accelerate config
CCL_TOPO_FABRIC_VERTEX_CONNECTION_CHECK=1 accelerate launch src/training/seq_2_seq.py\
    --model_name KHuss/gpt2_sft_levantine_bw --dataset "KHuss/UFAL_levantine_buckwater_seq2seq" \
    ...
    --subdirectory seq2seq/bw --save_model \
